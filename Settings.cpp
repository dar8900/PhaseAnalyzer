...
const ENUM_VAL LogMeasureEnum[MAX_MEASURE_LOG] = 
{
	...
	{&PAtt.actual	, "Potenza attiva"   , LOG_MEASURE_TYPE},
	{&PRea.actual	, "Potenza reattiva" , LOG_MEASURE_TYPE},
	{&PApp.actual	, "Potenza apparente", LOG_MEASURE_TYPE},
...
const SETTING_DEF Settings[MAX_SETTINGS] = 
{
	...
	{&SettingsVals[ENABLE_LOG_MEASURE]    	, 0		     , 1 					, ENUM_TYPE , LogEnable			     , ""   , "Abilita log"},
	{&SettingsVals[OVER_CURRENT_VALUE]      , 1			 , 15 			 	    , VALUE_TYPE, NULL				     , "A"  , "Sovra corrente"},
	{&SettingsVals[ENABLE_OVER_CURRENT]     , 0			 , 1  			 	    , ENUM_TYPE , OverCurrentEnableEnum  , ""   , "Abilita sovra corrente"},
	{&SettingsVals[UNDER_CURRENT_VALUE]     , 0			 , 1  			 	    , VALUE_TYPE, NULL				     , "A"  , "Sotto corrente"},
	{&SettingsVals[ENABLE_UNDER_CURRENT]    , 0			 , 1  			 	    , ENUM_TYPE , UnderCurrentEnableEnum , ""   , "Abilita sotto corrente"},
	{&SettingsVals[OVER_ATT_POWER_VALUE]    , 1000	     , 3500 		        , VALUE_TYPE, NULL					 , "W"  , "Sovra potenza att."},
	{&SettingsVals[ENABLE_OVER_PATT_POWER]  , 0			 , 1    				, ENUM_TYPE , OverPAttEnableEnum	 , ""   , "Abitlita sovra pot.att."},
	{&SettingsVals[UNDER_ATT_POWER_VALUE]   , 0			 , 1000 				, VALUE_TYPE, NULL					 , "W"  , "Sotto potenza att."},
	{&SettingsVals[ENABLE_UNDER_PATT_POWER] , 0			 , 1    				, ENUM_TYPE , UnderPAttEnabledEnum   , ""   , "Abitlita sotto pot.att."},
	{&SettingsVals[AVG_TIME]				, 1			 , 30   				, VALUE_TYPE, NULL					 , "min", "Tempo di media"},
	{&SettingsVals[SIMULATION_MODE]  		, 0			 , 1    				, ENUM_TYPE , SimulationEnabledEnum  , ""   , "Abilita simulazione"},
};